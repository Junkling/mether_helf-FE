    ...
    <section class="py-5 text-center container">
      ...
      <div class="button-right">
        <button
          ...
          onclick="location.href = '/murthehelp/admin/first_categories/add'"
        >
...
export default {
  ...
  setup() {
    ...
    const load = () => {
      axios
        .get(`/api/admin/first-categories`, {
          params: {
    ...
    const showDetail = (id) => {
      router.push({ path: `/murthehelp/admin/first_category/${id}` });
    };
    load();
